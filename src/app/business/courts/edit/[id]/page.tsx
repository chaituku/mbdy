// src/app/business/courts/edit/[id]/page.tsx
"use client";
...
export default function EditCourt() {
        ...
        const mockCourts = [
          ...
          },
          {
            ...
            features: {
              ledLighting: true,
              woodenFlooring: false,
              syntheticFlooring: true,
              shuttlecockService: true,
              airConditioning: true,
              waterDispenser: true,
              changingRoom: true,
              spectatorSeating: true
            },
            status: "active",
          },
          {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // In a real implementation, this would call an API to update the court
      console.log("Court data to be updated:", formData);
  ...
  if (notFound) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center">
        <div className="text-xl">Court not found</div>
        <button
